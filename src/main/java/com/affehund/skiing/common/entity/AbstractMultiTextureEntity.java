...
public abstract class AbstractMultiTextureEntity extends AbstractControllableEntity {
    ...
    protected void defineSynchedData() {
        ...
        entityData.define(SKIING_MATERIAL, Objects.requireNonNull(Blocks.OAK_PLANKS.getRegistryName()).toString());
    }
    ...
    public void setSkiingMaterial(Block material) {
        entityData.set(SKIING_MATERIAL, Objects.requireNonNull(material.getRegistryName()).toString());
