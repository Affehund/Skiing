...
public class ModEntities {
	...
	public static final RegistryObject<EntityType<SkisEntity>> SKI_ENTITY = ENTITIES.register(
			...
			() -> EntityType.Builder.<SkisEntity>of(SkisEntity::new, EntityClassification.AMBIENT)
					.sized(1.875f, 0.3f)
	...
	public static final RegistryObject<EntityType<SnowboardEntity>> SNOWBOARD_ENTITY = ENTITIES.register(
			...
			() -> EntityType.Builder.<SnowboardEntity>of(SnowboardEntity::new, EntityClassification.AMBIENT)
					.sized(1.75f, 0.1875f)
